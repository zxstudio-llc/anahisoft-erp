...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Editar', href: '/admin/testimonials/edit' }
];
...
export default function Edit({ testimonial }: { testimonial: any }) {
  const form = useForm({
  ...
  const currentPhotoUrl = testimonial.photo_url;
  ...
  const onSubmit = async (data: z.infer<typeof testimonialSchema>) => {
    try {
      ...
      await router.post(`/admin/testimonials/${testimonial.id}`, formData, {
        onSuccess: () => {
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="hidden h-full flex-1 flex-col space-y-8 p-8 md:flex">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Editar testimonio</h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Deja en blanco para mantener la foto actual
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                ...
                <div className="flex justify-end gap-4">
                  ...
                  <Button type="submit" disabled={form.formState.isSubmitting}>
                    {form.formState.isSubmitting ? 'Actualizando...' : 'Actualizar Testimonio'}
                  </Button>
                </div>
              </form>
            </Form>
